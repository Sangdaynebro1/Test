...
task.spawn(function()
  if not _env.LoadedHideUsername then
    ...
    local function Update()
      ...
      Label.Text = ("%s • Lv. %i%s"):format("ChuBeDan", Level, IsMax and " (Max)" or "")
    end
...
local Window = redzlib:MakeWindow({ Title = "VnWorld Hub: Meme Sea", SubTitle = "By ChuBeDan", SaveFolder = "redzHub-MemeSea.json" })
